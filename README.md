...
- [Datai Network](#datai-network)
  - [What is Datai Network?](#what-is-datai-network)
  - [What are the different actors within the Datai Network?](#what-are-the-different-actors-within-the-datai-network)
    - [Developers](#developers)
    - [Nodes](#nodes)
    - [Data Consumers](#data-consumers)
  - [DATAI token workflow](#datai-token-workflow)
