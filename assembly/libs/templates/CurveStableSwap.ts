...
export class CurveStableSwap extends ethereum.SmartContract {
  static bind(address: Address): CurveStableSwap {
    return new CurveStableSwap('CurveStableSwap', address)
  }
  ...
  coins1(arg0: BigInt): Address {
    let result = super.call('coins', 'coins(uint128):(address)', [
      ethereum.Value.fromUnsignedBigInt(arg0)
    ])
  ...
  try_coins1(arg0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall('coins', 'coins(uint128):(address)', [
      ethereum.Value.fromUnsignedBigInt(arg0)
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  try_future_A_time(): ethereum.CallResult<BigInt> {
    let result = super.tryCall('future_A_time', 'future_A_time():(uint256)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
