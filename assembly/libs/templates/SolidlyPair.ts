...
export class Pair extends ethereum.SmartContract {
  ...
  claimFees(): Pair__claimFeesResult {
    const result = super.call('claimFees', 'claimFees():(uint256,uint256)', [])

    return new Pair__claimFeesResult(result[0].toBigInt(), result[1].toBigInt())
  }
  ...
  current(tokenIn: Address, amountIn: BigInt): BigInt {
    const result = super.call('current', 'current(address,uint256):(uint256)', [
  ...
  feeRatio(): BigInt {
    const result = super.call('feeRatio', 'feeRatio():(uint256)', [])

    return result[0].toBigInt()
  }

  try_feeRatio(): ethereum.CallResult<BigInt> {
    const result = super.tryCall('feeRatio', 'feeRatio():(uint256)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
  ...
  fees(): Address {
    const result = super.call('fees', 'fees():(address)', [])

    return result[0].toAddress()
  }

  try_fees(): ethereum.CallResult<Address> {
    const result = super.tryCall('fees', 'fees():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
  ...
  metadata(): Pair__metadataResult {
    const result = super.call(
      'metadata',
      'metadata():(uint256,uint256,uint256,uint256,bool,address,address,uint256)',
      []
    )
  ...
  reserve0(): BigInt {
    const result = super.call('reserve0', 'reserve0():(uint256)', [])

    return result[0].toBigInt()
  }

  try_reserve0(): ethereum.CallResult<BigInt> {
    const result = super.tryCall('reserve0', 'reserve0():(uint256)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
  ...
  reserve1(): BigInt {
    const result = super.call('reserve1', 'reserve1():(uint256)', [])

    return result[0].toBigInt()
  }

  try_reserve1(): ethereum.CallResult<BigInt> {
    const result = super.tryCall('reserve1', 'reserve1():(uint256)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
  ...
  stable(): boolean {
    const result = super.call('stable', 'stable():(bool)', [])

    return result[0].toBoolean()
  }

  try_stable(): ethereum.CallResult<boolean> {
    const result = super.tryCall('stable', 'stable():(bool)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
