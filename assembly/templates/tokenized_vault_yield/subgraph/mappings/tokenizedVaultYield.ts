...
import { VaultUserPosition, Vault } from '../../generated/schema'
import {
  Deposit,
  Transfer,
  TokenizedVaultYield
} from '../../generated/TokenizedVaultYield0/TokenizedVaultYield'
...
export function handleDeposit(event: Deposit): void {
  ...
  // Protocol logic
  let vaultUserPosition = VaultUserPosition.load(positionId)
  if (vaultUserPosition == null) {
    vaultUserPosition = new VaultUserPosition(positionId)
    vaultUserPosition.user = userId
